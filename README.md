...
- 定时轮询多个公网 IP 查询服务，自动容错；默认包含 `api.ipify.org`、`ipv4.icanhazip.com`、`ifconfig.me/ip`，并兼容 `cip.cc`
...
services:
  ...
  public-ip-monitor:
    ...
    environment:
      ...
      PUBLIC_IP_SERVICES: https://api.ipify.org,https://ipv4.icanhazip.com,https://ifconfig.me/ip,http://cip.cc
